    ...
    if ( event.phase == "began" ) then
        ...
        if ( ( obj1.id == "enemy" and obj2.id == "bullet" ) or
           ...
           function corpseRemoval( event )
            ...
            timer.performWithDelay( 4000, corpseRemoval)
...
function scene:create( event )
    ...
    local sheetRobotIdle = graphics.newImageSheet( "assets/spritesheets/robot/robotIdle.png", sheetOptionsIdleRobot:getSheet() )

    local sheetOptionsDeadRobot = require( "assets.spritesheets.robot.robotDead" )
    local sheetRobotDead = graphics.newImageSheet( "assets/spritesheets/robot/robotDead.png", sheetOptionsDeadRobot:getSheet() )
    ...
    robot = display.newSprite( sheetRobotIdle, sequence_data )
    robot.x = 1024
    robot.y = 0
    robot.sequence = "idle"
    robot.xScale = -1
    ...
    local jumps = display.newText( "Jump", 1500, 1300, native.systemFont, 30 )
    local shoots = display.newText( "shoot", 1700, 1300, native.systemFont, 30 )
    ...
    sceneGroup:insert( jumps )
    sceneGroup:insert( shoots )
